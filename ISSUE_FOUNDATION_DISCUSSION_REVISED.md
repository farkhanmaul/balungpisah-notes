...
However, as someone who wants this to succeed in practice (not just theory), I have some concerns about issues that seem under-discussed or unaddressed in the current documentation. I don't have all the answers, and I may be missing context or plans that already exist offline. Please take this as discussion-starter, not criticism.
...
With 500 reports in 2 months (based on public data), early adopters are already using AI SAKSI. If they don't trust it, word-of-mouth will be: "sistem ngaco" → adoption stalls.
...
**The concern:**
I couldn't find discussion of AI inference costs at scale in the paper.

**Rough math (may be wrong):**
- Current: ~500 reports / 2 months
- Fase 1 target: 1,000 testimonies (**Section 10, Peta Jalan**)
- Future scale: More testimonies = more API calls
...
**Why this matters:**
Unsolved AI inference costs can bankrupt even successful platforms. Better to plan for this now than hit a wall later.

---

## 🧠 3. Hallucination & Liability (Addressed in Section 7.2, but for AI)

**What the paper says:**
- **Section 7.2:** Slashing protocol for verifiers
- **Section 8.2:** Stochastic jury for disputes
...
## 📊 4. Training Data & Bias (Partially Addressed in ESCO-ID, Section 8.4)
...
## 👥 5. Human Verification Bottleneck (Addressed in Section 8.2, but assumes infinite supply)
...
- 10,000 reports/month (future scale)
- Human verification needed: 20% = 2,000 reports/month
...
## 🏚️ 6. Digital Divide 2.0 (Not Addressed in Fase 1-3, Section 10)

**What the paper says:**
- **Section 10 (Peta Jalan):** Three phases (SAKSI → TANDANG → RESTORASI)
- Implied: App-based interface

**The concern:**
AI makes things more accessible for some, but may create new barriers for others.

**Current barriers (acknowledged):**
...
## 🏛️ 7. Institutional Self-Preservation (Not Addressed in Section 11)

**What the paper says:**
- **Section 2.1:** Critique of current bureaucratic system
- **Section 11:** Suggests government can use Balungpisah data
...
## ⚖️ 8. Power Dynamics in Small Communities (Addressed in Section 4.1, but theoretical)

**What the paper says:**
- **Section 4.1 (SAKSI):** "Identitas dapat dilindungi"
...
## 🔧 9. App-First Distribution (Not Addressed in Section 10-11)

**What the paper says:**
- **Section 10-11:** Three phases, platform implementation
...
## 🎭 10. Political & Cultural Complexity (Not Addressed in Section 5.1.1)

**What the paper says:**
- **Section 4.2 (TANDANG):** "Siapa pun dapat mengklaim dan menyelesaikan masalah"
- **Section 5.1.1:** Problem types categorized (Type A-D)
...
4. Does system acknowledge LIMITATIONS?
   ...
   - Is Balungpisah honest about its scope?
...
## 🎯 11. Genesis Authority Timeline (Addressed in Section 7.1, but may be optimistic)

**What the paper says:**
- **Genesis Layer (Jejak Tapak 7.1):** Genesis nodes
- **Genesis authority:** "Bobot ini meluruh 10% per bulan. Dalam kurang-lebih 10 bulan, otoritas awal sebuah Simpul Genesis mencapai nol."

**The concern (acknowledged in paper, but worth reinforcing):**
...
**Why this matters:**
Good intentions in design don't always survive implementation. Power tends to concentrate. Safeguards may need to be stronger.

---

## 📅 12. Phase Evaluation Criteria (Addressed in Section 10, but unclear metrics)

**What the paper says:**
- **Section 10 (Peta Jalan):** Fase 1-4 dengan milestones
- Fase 1: 1,000 kesaksian
- Fase 2: 100 masalah terselesaikan
- Fase 3: Ekspor CV Hidup, pengakuan eksternal

**The concern:**
Success criteria for continuing are unclear.
...
2. What is the minimum viable number?
   - Is 1,000 testimonies enough? 5,000? 10,000?
   - Is 10 kota/kabupaten enough? 50? 100?

3. What happens if a phase is partially successful?
   - Fase 1 target: 1,000, but only get 500?
   - Continue with modifications?
   - Extend timeline?
   - Pivot strategy?

**Why this matters:**
Clear success criteria help community rally toward goals. Vague criteria make it hard to feel ownership or know if we're on track.
...
That's why I'm raising these concerns now, with ~500 reports and 2 months in, rather than watching from the sidelines later.

**I don't have all the answers**, and I may be missing plans that exist offline. I would love to hear:
...
Terima kasih Mas Sabrang & team atas kerja kerasnya.
